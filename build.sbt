...
libraryDependencies ++= Seq(
   ...
   "ro.isdc.wro4j" % "wro4j-core" % "1.5.0" excludeAll(ExclusionRule(organization = "org.slf4j")),
   "ro.isdc.wro4j" % "wro4j-extensions" % "1.5.0" excludeAll(ExclusionRule(organization = "org.slf4j"))
)
