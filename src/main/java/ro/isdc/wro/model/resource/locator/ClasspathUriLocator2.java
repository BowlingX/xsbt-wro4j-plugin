 ...
 */
public class ClasspathUriLocator2
    extends WildcardUriLocatorSupport {
  private static final Logger LOG = LoggerFactory.getLogger(ClasspathUriLocator2.class);
  /**
  ...
  public InputStream locate(final String uri)
    ...
    return locate2(uri, Thread.currentThread().getContextClassLoader());
  }

public InputStream locate2(final String uri, ClassLoader classLoader) throws IOException {
    ...
    if (is == null) {
    	LOG.warn("failed to locate classpath resource:" + location);
